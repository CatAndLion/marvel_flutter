...
class ComicBook {
  ...
  ComicBook(this.id, this.thumbnail, this.title, this.issueNumber,
        this.description, this.format, this.pageCount);

  factory ComicBook.fromJson(Map<String, dynamic> json) => _$ComicBookFromJson(json);
}